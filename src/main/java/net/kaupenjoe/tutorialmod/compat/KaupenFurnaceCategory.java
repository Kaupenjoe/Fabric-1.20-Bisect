...
public class KaupenFurnaceCategory implements DisplayCategory<BasicDisplay> {
    public static final Identifier TEXTURE = new Identifier(TutorialMod.MOD_ID, "textures/gui/kaupen_furnace.png");
    public static final CategoryIdentifier<KaupenFurnaceDisplay> KAUPEN_FURNACE =
            CategoryIdentifier.of(TutorialMod.MOD_ID, "kaupen_furnace");
